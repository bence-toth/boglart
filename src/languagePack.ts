  ...
  programme: [
    ...
    },
    {
      ...
      schedule: [
        ...
        { time: "19:00", name: "", location: "" },
        { time: "19:15", name: "Puli", location: "Nagyszínpad" },
        { time: "19:45", name: "", location: "" },
        { time: "20:00", name: "Duo Compass (EE/UK)", location: "Kisszínpad" },
        { time: "20:15", name: "", location: "" },
        { time: "20:30", name: "Jezve (PL/GR/HU)", location: "Nagyszínpad" },
        { time: "21:30", name: "Dil Mastana (IN)", location: "Kisszínpad" },
        { time: "22:00", name: "", location: "" },
        { time: "22:15", name: "Glencz", location: "Nagyszínpad" },
        {
          time: "23:15",
          name: "Táncház — Házigazda: Kaptza",
          location: "Romkocsma",
  ...
  programme: [
    ...
    },
    {
      ...
      schedule: [
        ...
        { time: "19:00", name: "", location: "" },
        { time: "19:15", name: "Puli", location: "Main Stage" },
        { time: "19:45", name: "", location: "" },
        { time: "20:00", name: "Duo Compass (EE/UK)", location: "Small Stage" },
        { time: "20:15", name: "", location: "" },
        { time: "20:30", name: "Jezve (PL/GR/HU)", location: "Main Stage" },
        { time: "21:30", name: "Dil Mastana (IN)", location: "Small Stage" },
        { time: "22:00", name: "", location: "" },
        { time: "22:15", name: "Glencz", location: "Main Stage" },
        {
          time: "23:15",
          name: "Dance house hosted by Kaptza",
          location: "Ruin pub",
